        ...
        <div class="col-md-6 col-md-offset-3">
            <form id="msform"  action="" method="POST">
                ...
                <fieldset>
                    ...
                    <input type="text" name="MAKE" id="Ma"placeholder="MAKE" required/>
                    <input type="text" name="MODEL" id="Mo"placeholder="MODEL-NO" required/>
                    <input type="text" name="SERIAL" id="Se"placeholder="SERIAL-NO" />
                    <!-- <h2 class="fs-title">ENTRY-DETAILS</h2> -->
                    <input type="number" name="COUNT" id="Co"placeholder="COUNT" />
                    <input type="date" name="DATE" id="Da"placeholder="dd-mm-yyyy" required/>
                    <input type="text" name="EMPLOYEE" id="Em"placeholder="EMPLOYEE-NAME" required/>
